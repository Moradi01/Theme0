...
add_filter('ai1wm_exclude_content_from_export', 'ingonreCertainFiles' );

function ingnoreCertainFiles($exclude_filters) {
  $exclude_filters[] = 'themes/Amir-theme/node_module';
